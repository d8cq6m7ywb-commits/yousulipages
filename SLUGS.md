...
| `find-your-race.html`      | `/find-your-race`                 | yes (public, indexable), data-backed race-selection service page (Race Selection Review $179 / Qualification Strategy $399, free with coaching). Contact-to-book, no payment link (the Hub matchmaking tool is internal). Needs a Wix page. Funnel: linked from the `/imim70worlds` coach note; also described on `/coaching` + `/` |
